...
def test_sync_deals_by_filter():
    ...
    """
    deal_data = json.load(open(os.path.join(pytest.TEST_DIR, "mock_data/deals.json")))
...
def test_sync_tasks_by_filter():
    ...
    """
    task_data = json.load(open(os.path.join(pytest.TEST_DIR, "mock_data/tasks.json")))
